...
import { Cluster, Events } from '../types/types';

export class BaseInstaller extends EventEmitter {
  name: string;
  _target: any;
  debug: string;
  ...
  async load(): Promise<BaseInstaller> {
...
export const Installer = BaseInstaller;
